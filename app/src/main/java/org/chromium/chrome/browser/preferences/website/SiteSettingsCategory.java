...
public class SiteSettingsCategory {
    ...
    public static final String CATEGORY_SECURE_CONNECT = "secure_connect_sites";
    ...
    public static SiteSettingsCategory fromString(String category) {
        ...
        if (CATEGORY_SECURE_CONNECT.equals(category)) {
            return new SiteSettingsCategory(CATEGORY_SECURE_CONNECT, "",
    ...
    public static SiteSettingsCategory fromContentSettingsType(int contentSettingsType) {
        ...
        if (contentSettingsType == ContentSettingsType.CONTENT_SETTINGS_TYPE_SECURE_CONNECT) {
            return fromString(CATEGORY_SECURE_CONNECT);
        }
    ...
    /**
     * @return whether this category is the Secure Connect category.
     */
    public boolean showSecureConnectSites() {
        return mContentSettingsType ==
                ContentSettingsType.CONTENT_SETTINGS_TYPE_SECURE_CONNECT;
    }
