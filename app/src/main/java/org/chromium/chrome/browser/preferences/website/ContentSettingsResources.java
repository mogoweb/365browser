...
public class ContentSettingsResources {
    ...
    private static Map<Integer, ResourceItem> getResourceInfo() {
        ...
        if (sResourceInfo == null) {
            ...
            localMap.put(ContentSettingsType.CONTENT_SETTINGS_TYPE_SECURE_CONNECT,
                    new ResourceItem(R.drawable.img_deco_smartprotect_secure_connect,
                            R.string.secure_connect_title, R.string.secure_connect_title,
                            ContentSetting.ALLOW, ContentSetting.BLOCK,
                            R.string.secure_connect_about_text, R
                            .string.website_settings_category_disabled));
