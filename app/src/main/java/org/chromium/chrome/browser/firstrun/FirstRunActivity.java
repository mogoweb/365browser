...
public class FirstRunActivity extends AppCompatActivity implements FirstRunPageDelegate {
    ...
    static final String SHOW_SECURE_CONNECT_PAGE = "ShowSecureConnectPage";
    ...
    private void createPageSequence() {
        ...
        if (mFreProperties.getBoolean(SHOW_SECURE_CONNECT_PAGE)) {
            mPages.add(pageOf(SecureConnectFirstRunFragment.class));
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FirstRunFlowSequencer(this, mFreProperties) {
            ...
            public void onFlowIsKnown(Bundle freProperties) {
                ...
                recordFreProgressHistogram(getPageProgressState(0));
    ...
    private int getPageProgressState(int index) {
        FirstRunPage page = (FirstRunPage) mPagerAdapter.getItem(index);

        if (page instanceof ToSAndUMAFirstRunFragment) {
            return FRE_PROGRESS_WELCOME_SHOWN;
        } else if (page instanceof DataReductionProxyFirstRunFragment) {
            return FRE_PROGRESS_DATA_SAVER_SHOWN;
        } else if (page instanceof AccountFirstRunFragment) {
            return FRE_PROGRESS_SIGNIN_SHOWN;
        }
    ...
    */
    ...
    private boolean jumpToPage(int position) {
        ...
        recordFreProgressHistogram(getPageProgressState(position));
        return true;
    }
