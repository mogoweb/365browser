...
public class HomepageManager {
    ...
    public static boolean isHomepageEnabled(Context context) {
        // default partner homepage uses empty string [""] to launch NTP
        // which fails Textutils we should only care about null
        return (PartnerBrowserCustomizations.getHomePageUrl() != null)
