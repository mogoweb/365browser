...
public class AppMenuPropertiesDelegate {
    ...
    public void prepareMenu(Menu menu) {
        ...
        if (isPageMenu && currentTab != null) {
            ...
            // shortcuts in incognito mode and then open the webapp in regular mode, but enable it
            // in incognito only browser. Also check if creating shortcuts is supported at all.
            ...
            homescreenItem.setVisible(
                    canAddShortcutToHomescreen && !isChromeScheme
                            && (!isIncognito || isIncognitoOnlyBrowser));
