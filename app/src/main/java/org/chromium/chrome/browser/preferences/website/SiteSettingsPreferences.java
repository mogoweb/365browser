...
public class SiteSettingsPreferences extends PreferenceFragment
    ...
    static final String SECURE_CONNECT_KEY = "secure_connect_sites";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!SecureConnectPreferenceHandler.isInitialized()) {
            getPreferenceScreen().removePreference(findPreference(SECURE_CONNECT_KEY));
        }
    ...
    private int keyToContentSettingsType(String key) {
        ...
        } else if (SECURE_CONNECT_KEY.equals(key)) {
    ...
    private void updatePreferenceStates() {
        ...
        if (mMediaSubMenu) {
            ...
            if (SecureConnectPreferenceHandler.isInitialized()) {
                websitePrefs.add(SECURE_CONNECT_KEY);
            }
        ...
        for (String prefName : websitePrefs) {
            ...
            } else if (SECURE_CONNECT_KEY.equals(prefName)) {
                PrefServiceBridge.getInstance().setSecureConnectDefault();
                checked = PrefServiceBridge.getInstance().isSecureConnectEnabled();
            }
            ...
            if (AUTOPLAY_KEY.equals(prefName)
                ...
                p.setSummary(ContentSettingsResources.getGeolocationAllowedSummary());
                    ...
                    || SECURE_CONNECT_KEY.equals(prefName)) {
