...
public class ChromeTabbedActivity extends ChromeActivity implements OverviewModeObserver {
    ...
    private void createInitialTab() {
        ...
        if (TextUtils.isEmpty(url)
                || getResources().getBoolean(R.bool.swe_feature_force_ntp_landing_page)) {
    ...
    public boolean handleBackPressed() {
        final boolean exitDialogEnabled =
            getResources().getBoolean(R.bool.swe_feature_exit_dialog);
        ...
        if (minimizeApp) {
            if (shouldCloseTab) {
                ...
                if (exitDialogEnabled) {
                    showExitDialog(this, currentTab);
                    return true;
                }
     ...
     */
    public void sendToBackground(@Nullable final Tab tabToClose) {
